 ...
 * remote server.
 */
public class RemoteRuntimeUsageRegistry extends RemoteStoreClient implements RuntimeUsageRegistry {
  ...
  public void register(Id.Program programId, Id.DatasetInstance datasetInstanceId) {
    ...
    executeRequest("registerDataset",
                   programId, datasetInstanceId);
  }

  @Override
  public void register(Id.Program programId, Id.Stream streamId) {
    executeRequest("registerStream",
                   programId, streamId);
  }
