 ...
 * server.
 */
public class RemoteLineageWriter extends RemoteStoreClient implements LineageWriter {
  ...
  public void addAccess(Id.Run run, Id.DatasetInstance datasetInstance, AccessType accessType,
    ...
    executeRequest("addDatasetAccess",
                   run, datasetInstance, accessType, component);
  }
  ...
  public void addAccess(Id.Run run, Id.Stream stream, AccessType accessType, @Nullable Id.NamespacedId component) {
    ...
    executeRequest("addStreamAccess",
                   run, stream, accessType, component);
  }
