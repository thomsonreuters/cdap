...
public class LogHandler extends AbstractHttpHandler {
   ...
   * @param readRange range to be adjusted
   * @param runRecord run record for which the range to be adjusted
   * @param fromTimeSpecified true if called from logs endpoint and start time is explicitly specified by user
