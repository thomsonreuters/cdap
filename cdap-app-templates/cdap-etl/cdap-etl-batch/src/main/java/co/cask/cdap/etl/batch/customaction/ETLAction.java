 ...
 */
public class ETLAction extends AbstractCustomAction {
  ...
  public ETLAction(BatchPhaseSpec phaseSpec) {
  ...
  protected void configure() {
    ...
    setDescription("CustomAction phase executor. " + phaseSpec.getDescription());
